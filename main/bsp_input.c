...
static void touch_button_left_press_cb(void *arg, void *data) {
    const bsp_input_event_t event = BSP_TOUCH_BUTTON_LEFT_PRESS;
    xQueueSendFromISR(bsp_input_queue, &event, NULL);
}

static void touch_button_right_press_cb(void *arg, void *data) {
    const bsp_input_event_t event = BSP_TOUCH_BUTTON_RIGHT_PRESS;
    xQueueSendFromISR(bsp_input_queue, &event, NULL);
}
...
static void bsp_button_init(void) {
    ...
    iot_button_register_cb(knob_btn_handle, BUTTON_PRESS_REPEAT, knob_button_press_repeat_cb, NULL);
    iot_button_register_cb(touch_btn_left_handle, BUTTON_SINGLE_CLICK, touch_button_left_press_cb, NULL);
    iot_button_register_cb(touch_btn_right_handle, BUTTON_SINGLE_CLICK, touch_button_right_press_cb, NULL);
}
...
char *bsp_input_event_to_string(bsp_input_event_t event) {
    switch (event) {
        ...
        case BSP_TOUCH_BUTTON_LEFT_PRESS: return "BSP_TOUCH_BUTTON_LEFT_PRESS";
        case BSP_TOUCH_BUTTON_RIGHT_PRESS: return "BSP_TOUCH_BUTTON_RIGHT_PRESS";
